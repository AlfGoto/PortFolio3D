...
var videoARR = [
    ...
    new video('fenetreS', 'This is a little project done just to see if it was possible. <br>The concept here is to connect scripts from multiples navigators and windows to make them act together<br>It was fun to do and the effect is really cool. <br>It could be useful sometime later !', ['JS', 'CSS']),
